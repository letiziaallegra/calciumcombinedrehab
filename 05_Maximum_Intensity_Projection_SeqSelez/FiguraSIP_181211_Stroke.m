...
subjectList = {'GCaMPChR2_8_stroke', 'GCaMPChR2_9_stroke', 'GCaMPChR2_19_stroke',...
     'GCaMPChR2_22_stroke', 'GCaMPChR2_25_stroke', 'GCaMPChR2_26_stroke'};
weekList = {'1'};
...
fig = figure('name', 'GlobalSiP-STROKE');
subplot(2,4,1)
imshow(median(week1Sip,3)/max(max(median(week1Sip,3))), 'colormap', jet)
