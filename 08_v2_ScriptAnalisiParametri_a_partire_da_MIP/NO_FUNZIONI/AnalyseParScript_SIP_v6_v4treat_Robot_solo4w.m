...
% N.B. I gruppi in modalità 5 giorni sono CONTROL STROKE REHAB4W REHAB1w ROBOT4w
ONLY_ROBOT_4W = 1;
...
dirAllDataGCamp = ['C:\Users\',User,'\Google Drive\Piattaforma Stefano\ELABORAZIONE DATA\_data_MAT_GCamp_Store'];
%list animals
        ...
        if strfind(NameFile_GCamp_Day,'_Par_MIPSIP_Par') %if exist
            ...
            for itr=1:length(Treat) %for length Treat
                ...
                if length(Treat)>1 %FIRST and LAST REHAB WEEK
                    ...
                    %%%
                    %%% Robot 
                    elseif Treat(itr) == 21 %LAST REHAB WEEK
                    ...
                    if isfield(dataGCamp,'ROI_MIP_SIP_PeaksPar_Fx_Fluo') %if PeaksPar_Fx_Fluo
                        ...
                        for ip=1:NumPar  %if NumSig
                            ...
                            for iR=1:NumROI
                                ...
                                %update num animal
                                if Treat== 2 | Treat == 3 | Treat == 21 | Treat == 31
