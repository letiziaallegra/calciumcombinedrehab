function [res newfilename] = synchronize_vWebCam_LENS_v2(filenamePOS_RAW,filenameFORCE_RAW, path,targetPos)

%ricampionaro tutto a 100Hz
fs = 100;
Ts=1/fs;
overHome = 2; %mm
...
%ricampionato tutto a 100Hz
Pos      = resample(Pos,4,1);
len      = length(Pos);
Tsound2         = resample(Tsound2,4,1);
Tsound2_f_down  = Tsound2_f;
