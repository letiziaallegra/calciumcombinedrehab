...
load('Region_MACRO_Area_FunctionalMask_Index'); %-> RegionArea_FunctionalMask_Index MACRO AREAS
AREA_NAME   = {'CFA','Motor','Sensory','Other'};
FuncAres_ToTake      = {  2, 1, 3, 4};
...
for ind_TREAT =1:size(Count_Mk_MIP_STORE,1)
    ...
    for i_MS = 1:2
        ...
        if i_MS == 1
            ...
            %%% SIP %%
            CountData = Count_Mk_SIP_STORE{ ind_TREAT,1}; % -> scorre i 4 gruppi
        end
        ...
        CountDataNorm = CountData ./ repmat(SumData,size(CountData,1),1) *100; % -> righe=aree; colonne=animali
        ...
        %err std animals
        CountDataNorm_ERRSTD  = CountDataNorm_STD./sqrt(size(CountDataNorm,2));
        ...
        if i_MS == 1
            ...
            CountDataNorm_ERRSTD_TOT_SIP  = [CountDataNorm_ERRSTD_TOT_SIP    CountDataNorm_ERRSTD];
        end
...
figure('Name','SIP and functional Areas')

%CountDataNorm_MEAN_TOT_SIP => righe=aree ; colonne=treat
barwitherr([CountDataNorm_ERRSTD_TOT_SIP(1:end-1,1)...
            CountDataNorm_ERRSTD_TOT_SIP(1:end-1,2)...
            CountDataNorm_ERRSTD_TOT_SIP(1:end-1,3)...
            CountDataNorm_ERRSTD_TOT_SIP(1:end-1,4)...
            ],[...
            CountDataNorm_MEAN_TOT_SIP(1:end-1,1)...
            CountDataNorm_MEAN_TOT_SIP(1:end-1,2)...
            CountDataNorm_MEAN_TOT_SIP(1:end-1,3)...
            CountDataNorm_MEAN_TOT_SIP(1:end-1,4)...
            ]);
xlim([0.5 3.5])
set(gca,'XTick',1:3)
set(gca,'XTickLabel',{'CFA',  'Motor', 'Sensory'})
ylabel('% of areas constituting SIP')
legend({'Control', 'Stroke', 'RehabW1','RehabW4'})
