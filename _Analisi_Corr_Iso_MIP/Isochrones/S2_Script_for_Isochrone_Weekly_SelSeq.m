...
if MeaMed == 1
    %%%%%%% loading data folder
    DirData      = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\ELABORAZIONE DATA\_Analisi_Corr_Iso_MIP\Isochrones\Data_Isochrones_SelSeq\Data_Delay_Mean of Trials'];       
    %%%%%%% save data folder
    SaveDir      = [UsbPort,':\LENS\Isocrone_SelSeq\Figures_Weekly_Mean of Trials'];
    
elseif MeaMed == 2
    %%%%%%% loading data folder
    DirData      = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\ELABORAZIONE DATA\_Analisi_Corr_Iso_MIP\Isochrones\Data_Isochrones_SelSeq\Data_Delay_Median of Trials'];       
    %%%%%%% save data folder
    SaveDir      = [UsbPort,':\LENS\Isocrone_SelSeq\Figures_Weekly_Median of Trials'];
