...
if MeaMed == 1
    %%%%%%% loading data folder
    DirData      = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\ELABORAZIONE DATA\Isochrones\Data_Isochrones_SelSeq\Data_Delay_Mean of Trials'];       
    %%%%%%% save data folder
    SaveDir      = [UsbPort,':\LENS\Isocrone\Figures_Weekly_Mean of Trials'];
    
elseif MeaMed == 2
    %%%%%%% loading data folder
    DirData      = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\ELABORAZIONE DATA\Isochrones\Data_Isochrones_SelSeq\Data_Delay_Median of Trials'];       
    %%%%%%% save data folder
    SaveDir      = [UsbPort,':\LENS\Isocrone\Figures_Weekly_Median of Trials'];
...
for n_i = 1:1
    ...
    switch n_i
        ...
        case 1
            %control
            DirDataTreat = [DirData,'\Control'];
            num_week         = 1;
            num_day_per_week = 5;
            list_days = [1:5];
        case 2
            %stroke
            DirDataTreat = [DirData,'\Stroke'];
            num_week         = 1;
            num_day_per_week = 5;
            list_days = [1:5];
        case 3
            %rehab
            DirDataTreat = [DirData,'\Rehab'];
            num_week         = 4;
            num_day_per_week = 5;
            %list real day
...
%                     saveas(gca,[SaveDir,'\',fig_Name],'fig')
%                     saveas(gca,[SaveDir,'\',fig_Name],'jpeg')
                    close
