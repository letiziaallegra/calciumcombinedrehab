...
%%%%%%%%%%%%%%%% ISOCRONE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ISO_FOLDER  = [UsbPortHD,':\LENS\Isocrone\Figures _ Weekly _ Mean of Trials\Median'];
...
for LATo = 1:length(ListAnimalTogether)
    ...
    for i_week=1:Num_week %for week
        ...
        %%%%%%%%% MIP and SIP %%%%%%%%%%
        load([ROI_Folder,'\','Im_AlongDays_',Str_MIP_Week{i_week},Animal_Name,'_MIP_max']);
        Im_MIP    = Im_med;
        ...
        load([ROI_Folder,'\','Im_AlongDays_',Str_MIP_Week{i_week},Animal_Name,'_MIP_sum']);
        Im_SIP    = Im_med;
