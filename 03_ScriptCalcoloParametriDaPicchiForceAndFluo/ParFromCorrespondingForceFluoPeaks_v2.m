...
function [ParForce ParFluo] = ParFromCorrespondingForceFluoPeaks(SigForce, SigFluo, StartForcePeak, StartFluoPeak, EndForcePeak ,EndFluoPeak, numPksDer_Force, numPksDer_Fluo, stF_real, TimeWindow, dimOVS, trial_peak, status_peak, Fs, chTime)
