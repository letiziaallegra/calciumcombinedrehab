...
for lfcd=3:length(ListFolderAnimalDir)
    ...
    if exist([AnimalCurrDir,'\',DayCurrDir,'\',DataFilename])
        ...
        load([AnimalCurrDir,'\',DayCurrDir,'\','SequenceLong','\','DataInfoSequence_',Animal_Name,'_',DayCurrDir(1:2)])
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for id=1:NumSignals
            ...
            for iNPeaks=1:size(GoodForcePeaks,1) %for each force peaks
                ...
                StartForcePeak_sec           = StartForcePeak*Fs;           %[sec]    -> related to the whole signal
