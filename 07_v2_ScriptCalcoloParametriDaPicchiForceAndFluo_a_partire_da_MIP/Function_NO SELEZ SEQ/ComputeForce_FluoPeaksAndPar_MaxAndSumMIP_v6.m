...
RefOK = 1;
% ListAnimalTogether = {'GCaMPChR2_7_control',  'GCaMPChR2_17_control',...
%                       'GCaMPChR2_23_control','GCaMPChR2_24_control',...
...
ListAnimalTogether = {'GCaMP16_stroke_BoNT', 'GCaMP17_stroke_BoNT','GCaMP18_stroke_BoNT','GCaMPChR2_16_stroke_BoNT'};                  
...
for lfcd=3:length(ListFolderAnimalDir)
    ...
    if exist([AnimalCurrDir,'\',DayCurrDir,'\',DataFilename])
        ...
        dataGCamp.ROI_MIP_FluoPeaksAligned_to_FirstMov  = FluoPeaksAligned_to_FirstMov;
