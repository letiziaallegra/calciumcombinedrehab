...
%num Fluorescence ROIs based on Centroid and Radius
NumSignals = size(dataGCamp.CentroidAnalysis.ROI_Signal,2);
...
for id=1:NumSignals 
    ...
    %fluorescence signal based on Centroid and Radius
    FluoROI_Sig = dataGCamp.CentroidAnalysis.ROI_Signal(:,id);
...
dataGCamp.CentroidAnalysis.PeaksPar_Fx_Fluo  = PeaksPar_Fx_Fluo;
display('Parameter computation end')
 

%%% Save dataGCamp %%%
%%%%%%
filename_GCamp = ['dataMouseGCamp_',dataGCamp.Info.Name,'_',dataGCamp.Info.Date,'_Par','_Centroid','_Par'];
