...
% define the Fluo ROIs signals from NoBregmaREF data
%
clear
close all
clc
...
%%%%%%%% Animal_Name %%%%%%%%%%%%%%%%%%%
% Animal_Name_choice = 'GCaMPChR2_19_stroke';
% Animal_Name_choice = 'GCaMPChR2_20_control';
% Animal_Name_choice = 'GCaMPChR2_24_control';
Animal_Name_choice = 'GCaMPChR2_22_stroke';
% 
% Animal_Name_choice = 'GCaMPChR2_15_stroke_BoNT';
