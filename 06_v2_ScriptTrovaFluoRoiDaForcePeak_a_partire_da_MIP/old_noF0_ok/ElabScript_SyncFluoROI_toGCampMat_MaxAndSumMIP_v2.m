...
%%%%%%%% Animal_Name %%%%%%%%%%%%%%%%%%%
ListAnimalTogether = { 'GCaMPChR2_25_stroke'};


% ListAnimalTogether = {  'GCaMP16_stroke_BoNT','GCaMP17_stroke_BoNT','GCaMP18_stroke_BoNT','GCaMPChR2_11_stroke_BoNT', 'GCaMPChR2_12_stroke_BoNT',...
...
for LATo = 1:length(ListAnimalTogether)
    ...
    %%%%% LOAD data MIP %%%%%%%%%%%%%%%%%%%%
    ROI_MIP_Folder   = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\LENS_SSSA\ELABORAZIONE DATA\05_Maximum_Intensity_Projection\_Store_MIP_RegionBound\',Animal_Name_choice];
    ...
    %%%%% rot_transl %%%%%%%%%%%%%%%%%%%%%%%
    RotTranslFolder   = ['C:\Users\',UserName,'\Google Drive\Piattaforma Stefano\LENS_SSSA\ELABORAZIONE DATA\Script_Flip_Find_References\MAT_Rot_Trans'];
