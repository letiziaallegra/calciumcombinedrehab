%Script To compute Parameters Fluo-Force Peaks from MainCentroid ROI
...
for nAn_i=3:length(AnimalFolderList)
    ...
    for nDay_i=3:length(AnimalFolderDayList)
        ...
        DataFilename = ['dataMouseGCamp_',Animal_name,'_',currDay_str,'_Par_MainCentroid'];
        ...
        if exist([AnimalFolderDay,'\',DataFilename,'.mat'], 'file')
            ...
            NumSignals = size(dataGCamp.MainCentroid.ROI_Signal,2);
            ...
            for id=1:NumSignals
                ...
                %fluorescence sig MainCentroid
                FluoROI_Sig = dataGCamp.MainCentroid.ROI_Signal(:,id);
            ...
            dataGCamp.MainCentroid_PeaksPar_Fx_Fluo  = PeaksPar_Fx_Fluo;
