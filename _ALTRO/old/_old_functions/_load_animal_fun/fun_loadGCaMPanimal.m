...
elseif strcmp(Animal_Name,'GCaMPChR2_17_control')
    
    switch TrialDay
        case '01'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160307\'];
            folderTASK_FLUO = [folderTASK,'trialx15verovero'];
            folderTASK_ForceFileName = [folderTASK,'3_trialx8_sync.txt'];
        case '02'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160308\'];
            folderTASK_FLUO = [folderTASK,'trialx15_deep_seq'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep.txt'];
    end
%%%%% GCaMP4 %%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif strcmp(Animal_Name,'GCaMP15_stroke')
    ...
    switch TrialDay
        case '01'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151102\'];
            folderTASK_FLUO = [folderTASK,'sequenza_01_GCaMP15_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '02'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151103\'];
            folderTASK_FLUO = [folderTASK,'sequenza_02_GCaMP15'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '03'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151104\'];
            folderTASK_FLUO = [folderTASK,'sequenza_03_GCaMP15'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '04'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151105\'];
            folderTASK_FLUO = [folderTASK,'sequenza_04_GCaMP15_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '05'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151106\'];
            folderTASK_FLUO = [folderTASK,'sequenza_05_GCaMP15_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
    end
...
elseif strcmp(Animal_Name,'GCaMPChR2_9_stroke')
    ...
    switch TrialDay
        case '01'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160111\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx15_deep_01_GCaMPChR2_9'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '02'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160112\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx15_deep_02_GCaMPChR2_9'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '03'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160113\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx15_03_GCaMPChR2_9'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '04'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160114\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx15_04_GCaMPChR2_9'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '05'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_160115\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx12_05_GCaMPChR2_9'];
...
elseif strcmp(Animal_Name,'GCaMP12_stroke_BoNT')
    ...
    switch TrialDay
        ...
        case '02'
            ...
            folderTASK_FLUO = [folderTASK,'sequenza_GCAMP12_2_trialx10_1mmdeep'];
        ...
        case '08'
            ...
            folderTASK_FLUO = [folderTASK,'sequenza_GCAMP12_8_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15deep_sync.txt'];
        case '09'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151008\'];
            folderTASK_FLUO = [folderTASK,'sequenza_GCAMP12_9_trialx15deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15deep_sync.txt'];
        case '10'
            %post staccato
        ...
        case '11'
            ...
            folderTASK_FLUO = [folderTASK,'sequenza_11_GCamp12_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15deep_sync.txt'];
        case '12'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151013\'];
            folderTASK_FLUO = [folderTASK,'sequenza_GCAMP12_12_trialx15_1deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_1mmdeep_sync.txt'];
        case '13'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151014\'];
            folderTASK_FLUO = [folderTASK,'sequenza_GCAMP12_13_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '14'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151015\'];
            folderTASK_FLUO = [folderTASK,'sequenza_GCaMP12_14_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_1mmdeep_sync.txt'];
        case '15'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151016\'];
            folderTASK_FLUO = [folderTASK,'sequenza_GCaMP12_15_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '16'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151019\'];
            folderTASK_FLUO = [folderTASK,'sequenza_16_GCamp12_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_1mmdeep_sync.txt'];            
        case '17'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151020\'];
            folderTASK_FLUO = [folderTASK,'sequenza_17_GCaMP12_trialx15'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '18'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151021\'];
            folderTASK_FLUO = [folderTASK,'sequenza_18_GCaMP12_trialx15'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_1mmdeep_sync.txt'];
        case '19'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151022\'];
            folderTASK_FLUO = [folderTASK,'sequenza_19_GCaMP12_trialx15_1mmdeep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '20'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151023\'];
            folderTASK_FLUO = [folderTASK,'sequenza_20_GCaMP12_trialx15'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_1mmdeep_sync.txt'];
        case '20Sup'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\','20_151023\GCaMP12\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx5superf'];
            folderTASK_ForceFileName = [folderTASK,'trialx5_superf_sync.txt'];            
    end
...
elseif strcmp(Animal_Name,'GCaMP16_stroke_BoNT')
    ...
    switch TrialDay
        case '15'
            ...
            folderTASK_FLUO = [folderTASK,'sequenza_15_GCaMP16_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '16'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151207\'];
            folderTASK_FLUO = [folderTASK,'sequenza_16_GCamp16'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '17'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151208\'];
            folderTASK_FLUO = [folderTASK,'sequenza_17_GCaMP16'];
            folderTASK_ForceFileName = [folderTASK,'trialx13_sync.txt'];
        case '18'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151209\'];
            folderTASK_FLUO = [folderTASK,'sequenza_18_GCamp16'];
            folderTASK_ForceFileName = [folderTASK,'trialx15bis_sync.txt'];
        case '19'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151210\'];
            folderTASK_FLUO = [folderTASK,'sequenza_19_GCamp16'];
            folderTASK_ForceFileName = [folderTASK,'trialx13_sync.txt'];
        case '20'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151211\'];
            folderTASK_FLUO = [folderTASK,'sequenza_20_GCamp16'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
    end
...
%         case '16'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151207\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_16_GCaMP17_trialx15_deep'];
%             folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
%         case '17'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151208\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_17_GCaMP17_trialx15'];
%             folderTASK_ForceFileName = [folderTASK,'trialx10_sync.txt'];
%         case '18'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151209\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_18_GCaMP17_trialx15'];
%             folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
%         case '19'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151210\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_19_GCaMP17_trialx8'];
%             folderTASK_ForceFileName = [folderTASK,'trialx8_sync.txt'];
%         case '20'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151211\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_20_GCaMP17_trialx15'];
%             folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
    end
...
%         case '16'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151207\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_16_GCaMP18_trialx15_deep'];
%             folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
%         case '17'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151208\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_17_GCaMP18_trialx8'];
%             folderTASK_ForceFileName = [folderTASK,'trialx8_sync.txt'];
        case '18'
            folderTASK      = [UsbPort,':\LENS\Animals Data _ da sistemare\',Animal_Name,'\',TrialDay,'_151209\'];
            folderTASK_FLUO = [folderTASK,'sequenza_18_GCamp18_trialx15_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
%         case '19'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151210\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_19_GCaMP18_trialx14'];
%             folderTASK_ForceFileName = [folderTASK,'trialx14_sync.txt'];
%         case '20'
%             folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151211\'];
%             folderTASK_FLUO = [folderTASK,'sequenza_20_GCaMP18_trialx14'];
%             folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
    end
...
elseif strcmp(Animal_Name,'GCaMPChR2_3_stroke_BoNT')
    ...
    switch TrialDay
        case '15'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151204\'];
            folderTASK_FLUO = [folderTASK,'sequenza_trialx12_deep'];
            folderTASK_ForceFileName = [folderTASK,'trialx12_deep_sync.txt'];
        case '16'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151207\'];
            folderTASK_FLUO = [folderTASK,'sequenza_16_GCaMPChR2_3_trialx15_OK'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '17'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151208\'];
            folderTASK_FLUO = [folderTASK,'sequenza_17_GCaMPChR2_3_trialx15_OK'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_deep_sync.txt'];
        case '18'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151209\'];
            folderTASK_FLUO = [folderTASK,'sequenza_18_GCaMP_ChR2_3'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '19'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151210\'];
            folderTASK_FLUO = [folderTASK,'sequenza_19_GCaMP_ChR2_3'];
            folderTASK_ForceFileName = [folderTASK,'trialx15_sync.txt'];
        case '20'
            folderTASK      = [UsbPort,':\LENS\Animals Data\',Animal_Name,'\',TrialDay,'_151211\'];
            folderTASK_FLUO = [folderTASK,'sequenza_20_GCaMPChR2_3_trialx12_deep'];
