...
AnimalWhereSaveGCamp = ['C:\Users\',User,'\Google Drive\Piattaforma Stefano\LENS_SSSA\ELABORAZIONE DATA\_data_MAT_GCamp_Store_Ext'];
...
for lfcd=3:length(ListFolderAnimalDir)
    ...
    if exist([AnimalCurrDir,'\',DayCurrDir,'\',DataFilename])
        ...
        %%% Save dataGCamp %%%
        %%%%%%
        DataFilename_Par = [DataFilename(1:end-4),'_Par_Ext'];
