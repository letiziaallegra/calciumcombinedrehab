function ImageSequence = save_MatrixImageSequence_fun_Audio(Name,Date,MatrixImageSequence,CentralFrame,ROISelected,BeforeCentralFrame,AfterCentralFrame,downsamplingfactor)
...
Filename = ['ImageSequence_',Name,'_',Date,'_FirstAudio','_ROI_',num2str(ROISelected)];
